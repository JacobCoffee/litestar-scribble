...
project = "scribbl-py"
copyright = f"{datetime.now(tz=UTC).year}, Jacob Coffee"
author = "Jacob Coffee"

# Get version dynamically
try:
    from scribbl_py import __version__
...
html_theme_options = {
    "accent_color": "cyan",
    "github_url": "https://github.com/JacobCoffee/scribbl-py",
    "nav_links": [
        {"title": "Litestar", "url": "https://litestar.dev/"},
        {"title": "PyPI", "url": "https://pypi.org/project/scribbl-py/"},
    ],
    "toctree_collapse": False,
}

html_static_path = ["_static"]
html_title = "scribbl-py"
